                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.name}</b> <small style="color: gray;"> ' + data.cr.createTime + ' 由' + data.cr.createBy + '</small>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.name}</b> <small style="color: gray;" id="s' + n.id + '"> ' + (n.editFlag == 1 ? n.editTime : n.createTime) + ' 由' + (n.editFlag == 1 ? n.editBy : n.createBy) + '</small>';
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        <%--<tr>
                            <td><a href="transaction/detail.html" style="text-decoration: none;">CRM_ED-交易01</a></td>
                            <td>5,000</td>
                            <td>谈判/复审</td>
                            <td>90</td>
                            <td>2017-02-07</td>
...
<div class="modal fade" id="removeTransactionModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" id="deleteTranBtn" class="btn btn-danger">删除</button>
            </div>
        </div>
    </div>
</div>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label for="edit-customerName" class="col-sm-2 control-label">名称<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-customerName" value="CRM_ED">
                        </div>
                    </div>
...
<div style="position: relative; left: 40px; top: -30px;">
    <div class="page-header">
        <h3>客户-${c.name} <small><a href="${c.website}" target="_blank">${c.website}</a></small></h3>
    </div>
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#editCustomerModal"><span
                class="glyphicon glyphicon-edit"></span> 编辑
        </button>
        <button type="button" id="deleteBtn" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除
        </button>
    </div>
</div>
