    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#myInformationBtn").click(function () {
                ...
                $.ajax({
                    url: "settings/main/getUserInformation.do",
                    type: "get",
                    dataType: "json",
                    success: function (data) {

                        $("#myInformation-name").html(data.name)
                        $("#myInformation-id").html(data.id)
                        $("#myInformation-deptno").html(data.deptno)
                        $("#myInformation-email").html(data.email)
                        $("#myInformation-expireTime").html(data.expireTime)
                        $("#myInformation-allowIps").html(data.allowIps)
            ...
            $("#updatePwdBtn").click(function () {
                ...
                if (oldPwd == "" || newPwd == "" || confirmPwd == "") {
                    ...
                    $.ajax({
                        url: "settings/main/updatePwd.do",
                        data: {
                            "oldPwd": oldPwd,
                            "newPwd": newPwd
                        },
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="position: relative; left: 40px;">
                    姓名：<b id="myInformation-name">张三</b><br><br>
                    登录帐号：<b id="myInformation-id">zhangsan</b><br><br>
                    组织机构：<b id="myInformation-deptno">1005，市场部，二级部门</b><br><br>
                    邮箱：<b id="myInformation-email">zhangsan@bjpowernode.com</b><br><br>
                    失效时间：<b id="myInformation-expireTime">2017-02-14 10:10:10</b><br><br>
                    允许访问IP：<b id="myInformation-allowIps">127.0.0.1,192.168.100.2</b>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" id="updatePwdBtn">更新</button>
            </div>
        </div>
    </div>
</div>
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        CRM &nbsp;<span style="font-size: 12px;">&copy;1997&nbsp;ED夏</span></div>
        ...
        <ul>
            <li class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="javascript:void(0)" id="myInformationBtn"><span
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="workbench/main/test.jsp" target="workareaFrame"><span
