...
<head>
	...
	<script>
		...
		/*
            ...
            以阶段为key，通过选中之后，触发可能性value

            1.数据量不大
            2.键值对对应关系

            如果遇到如上情况，那么请将这样的数据，存到表中就没有意义
            遇到这样的情况给，我们需要用到properties属性文件进行保存
        ...
        */
		$(function () {
			...
			$("#create-stage").change(function () {
                ...
                我们是为了填写可能性
                阶段和可能性的对应关系，也有pMap
                但是pMap是Java中的键值对，map对象
                在js中用不了啊
                我们首先得将pMap转换为js中的键值对关系
...
<form action="workbench/tran/save.do" id="tranForm" method="post" class="form-horizontal" role="form"
	...
	<div class="form-group">
		...
		<label for="create-expectedClosingDate" class="col-sm-2 control-label timedown">预计成交日期<span
				style="font-size: 15px; color: red;">*</span></label>
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control timedown" id="create-expectedClosingDate " name="expectedDate">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="text" class="form-control timeup" id="create-nextContactTime " name="nextContactTime">
		</div>
	</div>
